...
function Auth() {
    ...
    const handleLogin = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('http://172.19.8.23:5000/api/auth/login', {
                method: 'POST',
    ...
    const handleRegister = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('http://172.19.8.23:5000/api/auth/register', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    name: formData.name,
    ...
    const handleForgot = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('http://172.19.8.23:5000/api/auth/forgot-password', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleReset = async (e) => {
        ...
        setLoading(true);
        try {
            const res = await fetch('http://172.19.8.23:5000/api/auth/reset-password', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({
                    email: formData.email,
