        ...
        >
            ...
            {orders.length === 0 ? (
                <View style={styles.emptyState}>
                    ...
                    <Text style={styles.emptyText}>No beverage orders to prepare.</Text>
                </View>
            ) : (
                orders.map(order => {
                    ...
                    return (
                        <View key={order.id} style={[styles.orderCard, { borderLeftColor: typeColor }]}>
                            ...
                            <View style={styles.orderInfoRow}>
                                ...
                                <Text style={styles.orderInfoText}>👤 {order.steward_name || 'System / Direct'}</Text>
                            ...
                            <View style={styles.orderActions}>
                                ...
                                <View style={{ flexDirection: 'row', gap: 8, flex: 2 }}>
                                    {order.status === 'PENDING' || order.status === 'CONFIRMED' ? (
                                        ...
                                        >
                                            <Text style={styles.statusBtnText}>MIXING DRINKS</Text>
                                        </TouchableOpacity>
                                    ) : (
                                        <TouchableOpacity 
...
const styles = StyleSheet.create({
    ...
    lockBtn: { backgroundColor: '#8B5CF6', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12 },
